...
<body>
    ...
    <section id="learn">
        <div class="global">
            <div class="principal-info" style="padding-bottom:0;">
                <h2>Saiba como os CEOs estão vendo a inovação na indústria</h2>
            </div>
            ...
            <p style="text-align:center; color:#808080;">Dicas rápidas, aprendizados e caminhos de quem já inova na indústria!</p>
